...
(function() {
  var Promise, browserify, buildPages, buildScripts, buildStyles, compileTemplate, compileTemplates, copyFontAwesome, copyImages, exec, fs, glob, log, mkdirp, moment, path, rimraf, rsvp, signalDone, signalError, startBuild, uglifyify, _;
  ...
  compileTemplates = function(ctx) {
    ...
    return new Promise(function(resolve, reject) {
      var cache, cacheFile, dest, jstSrc, sources;
